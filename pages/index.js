...
import { Analytics } from "@vercel/analytics/react"; export default function
Home() { return (
<div className="{styles.container}">
  ...
  <main>
    ...
    <h1 className="{styles.title}">
      <a href="https://www.nftindonesia.xyz" target="_blank"> NFT Indonesia </a
      >{" "} <code>init</code> Page!
    </h1>
    ...
    <div className="{styles.grid}">
      ...
      >
        ...
        <p>A link to official Farcaster account of NFT Indonesia.</p>
      </a>
      ...
      >
        ...
        <p>
          A link to send message to official email address of NFT Indonesia.
        </p>
      </a>
    </div>
  </main>
